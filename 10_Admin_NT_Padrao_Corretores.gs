...
const RHIMOB_NT_CORRETORES = {
  BUILD: 'RHIMOB_NT_PADRAO_CORRETORES_V9_2026_05_07',
...
function atualizarRelatorioPadraoCorretoresNovosTalentos() {
  ...
  const rel = supaGet_('/rest/v1/nt_relatorio_operadores_v9?select=data_consumo,conta_id,operador_nome,email_login,total_consumos&order=data_consumo.desc&limit=5000');
