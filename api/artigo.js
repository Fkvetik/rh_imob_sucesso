    ...
    <section class="article-hero">
      ...
      <div class="container">
        ...
        <div class="article-share">
          ...
          <a class="share-btn share-fb" href="https://www.facebook.com/sharer/sharer.php?u=${liUrl}" title="Facebook" target="_blank" rel="noopener" onclick="navigator.clipboard.writeText('${escJs(n.titulo)} — ${escJs(url)}').then(function(){window.__artToast&&window.__artToast('Legenda copiada! Cole no post do Facebook.')})">
